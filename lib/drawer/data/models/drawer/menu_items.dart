...
import 'package:elagk_delivery/drawer/presentation/components/log_out_section.dart';
import 'package:elagk_delivery/drawer/presentation/components/user_drawer_header.dart';
import 'package:elagk_delivery/shared/global/app_colors.dart';
import 'package:elagk_delivery/shared/utils/app__fonts.dart';
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                SizedBox(height: mediaQueryWidth(context) / AppSize.s2),
                const LogOutSection(),
