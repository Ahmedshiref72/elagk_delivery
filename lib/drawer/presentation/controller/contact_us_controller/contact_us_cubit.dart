...
import 'package:elagk_delivery/drawer/data/models/contact_us_model.dart';
...
void phoneCall()
{
  ...
  async {
    ...
    String uri = 'mailto:elagk_delivery@gmail.com?subject=${Uri.encodeComponent(subject)}&body=${Uri.encodeComponent(stringText)}';
