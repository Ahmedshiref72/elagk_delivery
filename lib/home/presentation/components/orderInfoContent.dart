...
import '../../data/models/GetPharmacyByIDModel.dart';
...
class OrderInformationContent extends StatelessWidget {
  OrderInformationContent({
    Key? key,
    this.Order, this.pharmacyModel,
  }) : super(key: key);
  final OrdersModel? Order;
  final GetPharmacyByIDModel? pharmacyModel;
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<OrderCubit,OrderState>(
      ...
      builder: (context,state){
       // if (state is getPharmacyByIdSuccessState) {
            ...
            children: [
              ...
              Row(
                children: [
                 ...
                 state is getPharmacyByIdSuccessState?
                  Text(
              ...
              Text(
                OrderCubit.get(context).getPharmacyByIDModel!.pharmacyName.toString(),
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),
              ),
              const SizedBox(
                height: 20,
              ...
              state is FollowOrderSuccessState?
              Padding(
